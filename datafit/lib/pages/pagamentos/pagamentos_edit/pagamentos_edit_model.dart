...
import 'pagamentos_edit_widget.dart' show PagamentosEditWidget;
...
class PagamentosEditModel extends FlutterFlowModel<PagamentosEditWidget> {
  ...
  // State field(s) for txtPagamento widget.
  FocusNode? txtPagamentoFocusNode;
  TextEditingController? txtPagamentoTextController;
  String? Function(BuildContext, String?)? txtPagamentoTextControllerValidator;
  // Stores action output result for [Backend Call - API (update  pgto aluno)] action in btConfirm widget.
  ...
  void dispose() {
    ...
    txtPagamentoFocusNode?.dispose();
    txtPagamentoTextController?.dispose();
  }
}
