...
import 'criaraluno_model.dart';
export 'criaraluno_model.dart';

class CriaralunoWidget extends StatefulWidget {
  const CriaralunoWidget({super.key});

  static String routeName = 'criaraluno';
  static String routePath = '/criaraluno';

  @override
  State<CriaralunoWidget> createState() => _CriaralunoWidgetState();
}

class _CriaralunoWidgetState extends State<CriaralunoWidget> {
  late CriaralunoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriaralunoModel());
    ...
    _model.niverTextController ??= TextEditingController();
    _model.niverFocusNode ??= FocusNode();

    _model.niverMask = MaskTextInputFormatter(mask: '##/##/####');
    _model.telTextController ??= TextEditingController();
    _model.telFocusNode ??= FocusNode();

    _model.telMask = MaskTextInputFormatter(mask: '(##) # ####-####');
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.niverTextController,
                                  focusNode: _model.niverFocusNode,
                                  autofocus: false,
                                  enabled: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  enableInteractiveSelection: true,
                                  validator: _model.niverTextControllerValidator
                                      .asValidator(context),
                                  inputFormatters: [_model.niverMask],
                                ),
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  enableInteractiveSelection: true,
                                  validator: _model.telTextControllerValidator
                                      .asValidator(context),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Theme(
                                      ...
                                      child: Checkbox(
                                        value: _model.checkwhatsValue ??= true,
                                        onChanged: (newValue) async {
                                          safeSetState(() => _model
                                              .checkwhatsValue = newValue!);
                                        },
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await actions.cadastrarAluno(
                                            ...
                                            _model.niverTextController.text,
                                            _model.telTextController.text,
                                            _model.checkwhatsValue!,
                                            double.tryParse(
