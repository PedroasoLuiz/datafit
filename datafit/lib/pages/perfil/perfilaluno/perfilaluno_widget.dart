                                  ...
                                  valueOrDefault<String>(
                                    dateTimeFormat(
                                      ...
                                      functions.formataData(
                                          FFAppState().alunotemp.ultimoAcesso),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  onTap: () async {
                                                    final picked =
                                                        await custom_widgets.showCustomDatePicker(
                                                      context,
                                                      initialDate: () {
                                                        final d = functions
                                                            .formataData(
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.min,
                                    children:
                                        List.generate(subagrupamentos.length,
                                            (subagrupamentosIndex) {
                                      final subagrupamentosItem =
                                          subagrupamentos[subagrupamentosIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if ('$subagrupamentosIndex-$exercicioIndex' ==
                                                                              _model.indexexercicios)
                                                                            SingleChildScrollView(
                                                                                primary: false,
                                      ...
                                      builder: (context) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder: (context, metasIndex) {
                                            final metasItem = metas[metasIndex];
                                            return InkWell(
                                              splashColor: Colors.transparent,
                                              focusColor: Colors.transparent,
                                              hoverColor: Colors.transparent,
